              ...
              $newDate = new DateTime($date);
                        ?>
                                     <td><?php echo $sn++; ?></td>
                                        ...
                                        <td class="badge badge-pill badge-success d-block mg-t-8"><a style="color:white" href="verify.php?dknkmdksssskdkldksllckdllsdklsokmxxlslslslsmxdlxassxomxmxhgshhnxmxkjskxikmmmnxkjxjksssssssdk=<?php echo $row['appId'];?>" ><?php echo $row['verify'];?>.</a></td>
                                        <!--<td>+ 123 9988568</td-->
