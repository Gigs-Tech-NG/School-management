  ...
  <div id="wrapper" class="wrapper bg-ash">
    ...
    <div id="pringtdableArea">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                         <div class="openBtn">
      <button class="openButton" onclick="openForm()"><strong>PRINT RECEIPT</strong></button>
                          ...
                          <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center">Acceptance transid</th>
                                        <!--<th>Class</th>
                                        <th>Subject</th--->
                                        <th align="center">Acceptance Paid</th>
                                        <th align="center" colspan="2">100LEVEL</th>
                                        <th align="center" colspan="2">200LEVEL</th>
                                        <th align="center" colspan="2">300LEVEL</th>
                                         <th  align="center" colspan="2">400LEVEL</th>
                                ...
                                <tbody>
                                 ...
                                 <div class="form-check">
                                     ...
                                     <td><?php echo $invoice;?></td>
                                        ...
                                        <!---<td>English</td--->
                         <td><?php if(($fee == "")){
                         echo "<p style='color:red'>PENDING</p>" ;}else{echo "PAID = # ".$fee;}?></td>
                 <td><?php if(($balance == "")){echo "<p style='color:red'>PENDING</p>";}else{ echo "BALANCE = # ".$balance ;}?></td>
                                              <td><?php if(($fee2 == "")){echo "<p style='color:red'>PENDING</p>";}else{ echo "PAID = # ".$fee2;}?></td>
                                          <td><?php if(($balance2 == "")){echo "<p style='color:red'>PENDING</p>";}else{ echo "BALANCE = # ".$balance2;}?></td>
                                                           <td><?php if(($fee3 == "")){echo "<p style='color:red'>PENDING</p>";}else{echo "PAID = # ".$fee3;}?>
                                                                    <td><?php if(($balance3 == "")){echo "<p style='color:red'>PENDING</p>";}else{echo "BALANCE = # ".$balance3;}?></td>
                                         <td><?php if(($fee4 == "")){echo "<p style='color:red'>PENDING</p>";}else{echo "PAID = # ".$fee4;}?></td>
                                           <td><?php if(($balance4 == "")){echo "<p style='color:red'>PENDING</p>" ;}else{echo "BALANCE = # ".$balance4;}?></td>
    ...
    if(isset($_POST['receipt'])){
        ...
        if(($LVL == 100)){
            ...
            echo"<script> location.href='action_page.php';</script>";
        
        }elseif($LVL == 200){
            $_SESSION['leveltwo']="true";
            echo"<script> location.href='feee.php';</script>";
        }
        elseif($LVL == 300){
            $_SESSION['levelthree']="true";
            echo"<script> location.href='scholfee.php';</script>";
        }
        elseif($LVL == 400){
            $_SESSION['levelfour']="true";
            echo"<script> location.href='feee_receipt.php';</script>";
        }
    }
         ...
         <select name="level" class="slect" required>
             ...
             <option>200LEVEL</option>
              <option>300LEVEL</option>
               <option>400LEVEL</option></select>
         
          <button type="submit" name="receipt" class="btn">CONTINUE</button>
