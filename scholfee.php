...
.boy {
	...
	if(empty($fee3)){
     ...
     window.location = "schoolfeeprint.php";
	    ...
	    echo '<script> alert("payment not yet confirmed contact admin to confirm")
     window.location = "schoolfeeprint.php";
     </script>';
	}
	   //invoice
...
<label></label>
    ...
    echo date('Y',time())+1;?></span></td>
				...
				<tr>
					...
					<td><span>#</span><span><?php echo $paymode3; ?></span></td>
				</tr>
				<tr>
					<th><span>Amount Paid</span></th>
					<td><span>#</span><span><?php echo $fee3; ?></span></td>
				</tr>
				
			
				<tr>
					<th><span>Balance Due</span></th>
					<td><span>#</span><span><?php echo $balance3; ?></span></td>
				</tr>
