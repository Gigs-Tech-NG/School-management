...
$select_qry= "SELECT * FROM admlogin WHERE code = '$id'";
...
if (isset($_POST['update'])) {
	...
	$update="UPDATE admlogin SET active='$active'
	WHERE code = '$id'";
                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                <h5 class="item-title"><?php echo $nameJ;?></h5>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="item-header">
                                <h6 class="item-title"><?php echo $nameJ;?></h6>
                            </div>
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="index.php" class="nav-link"><i class="flaticon-classmates"></i><span>Home</span>
                            </a>
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post" action="">
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="update" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">CONFIRM EMAIL ADDRESS</button>
