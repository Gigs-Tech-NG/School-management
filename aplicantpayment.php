...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
  ...
  <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/>
                ...
                <div class="card height-auto">
                    <div class="card-body">
    					...
    					while($row=mysqli_fetch_array($quer)){
                           ...
                           $income =  $total; 
    						?>
                                <h3>Applicants Payment History Total Income: #<?php echo $income;?> (<?php
    ...
    echo date('Y',time())+1;?> Session)</h3>
                        ...
                        $sn=0;
                        $sn=$sn+1;
                        $select="SELECT * FROM application WHERE admissionstatus = '$admitted' ORDER BY appId DESC";
                      // $select="SELECT * FROM applicants ORDER BY id DESC";
 ...
 <!--td class="badge badge-pill badge-success d-block mg-t-8"><a style="color:white" href="verified.php?dknkmdksssskdkldksllckdllsdklsokmxxlslslslsmxdlxassxomxmxhgshhnxmxkjskxikmmmnxkjxjksssssssdk=<?php// echo $row['appId'];?>" ><?php //echo $row['verify'];?>.</a></td-->
                                        <!--<td>+ 123 9988568</td-->
                                               <td><?php echo $row['phone']; ?></td>
                                        <td><?php echo $row['email']; ?></td>
                                         <td><?php echo $row['lecturer']; ?></td>
                                         <td><?php echo $newDate->format('M d,Y h:i:s a'); ?></td>
