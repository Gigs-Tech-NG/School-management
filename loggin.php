...
<head>
 <title>De Potter College || Re-defining lost hope</title>
   ...
   <meta charset="utf-8"> <?php require("includes/logIN.php"); ?> 
...
<body class="img js-fullheight" style="background-image:url(images/depoter.JPG);];height:auto">
...
<h3 class="mb-4 text-center" style="font-weight:600;margin-top:-5%">STUDENT LOGIN</h3>
 ...
 <form  data-toggle="validator" method="POST"  action="#">
     ...
     <i class="fa fa-user "  style="margin-top:5%;position:absolute;margin-left:5%;color:black"></i>
                                                                <input type="text" class="form-control" style="text-indent: 23px;border-color: #f6f9f3;" placeholder="Matric No" class="form-control" name="matricNo" required>
                                                            </div>     
                                                            <div class="form-group">
...
<a href="forgetting.php" style="color: #fff" target="_blank">Forgot Password?</a>
</div>
</div>
                                                        </form>
...
<?php if(isset($_SESSION['LOGGEDstudent'])){ echo "<script> location.href='student.php' </script>";
exit();}?>
</section>
