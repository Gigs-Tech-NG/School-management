    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
               ...
               <h4 style="color:red">Remove COURSES</h4>
...
<form action="removedelectcousre.php" method="post" class="regform" role="form" >
       ...
       <option value="">Select dept first </option>
                    ...
                    <option value="">Select level first </option>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Remove COURSE(S)</button>
                                     <div class="help-block with-errors"></div>
