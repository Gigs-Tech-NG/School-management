...
<form action="resultcheck.php" method="post" class="regform" role="form" >
       ...
       <option value="">Select dept first </option>
                    ...
                    <option value="THIRD TERM">THIRD TERM  </option>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Continue</button>
                                     <div class="help-block with-errors"></div>
