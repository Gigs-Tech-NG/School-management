...
<body>
	    <div class="row-fluid">
	        <div class="span12">
	            <div class="container">
		<br />
		<h1 style="text-align: center;"><p>Year 3 Lectures</p></h1>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" margin="-20%">
			...
			<?php
			$today = date('d/m/Y');
			$query=mysqli_query($connection,"SELECT * FROM  year_3 WHERE date = '$today' ORDER BY id ASC");
