  ...
  $.ajax({
   ...
   success:function(data)
   {
    for(var count=0; count<data.length; count++)
    {
     ...
     html_data += '<td data-name="lectureday1" class="lectureday1" data-type="select" data-pk="'+data[count].id+'">'+data[count].lectureday1+'</td>';
     html_data += '<td data-name="lectureday2" class="lectureday2" data-type="select" data-pk="'+data[count].id+'">'+data[count].lectureday2+'</td>';
