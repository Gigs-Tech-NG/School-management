            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Year2 <?php echo $faculty ;?> STUDENTS (<?php
    ...
    echo date('Y',time());?> )Session</li>
                ...
                <div class="card height-auto">
                    <div class="card-body">
    					...
    					include('config.php');
    					$lvel=200;
    					$quer=mysqli_query($connection,"SELECT fee_two FROM application WHERE level='$lvel'");
                        $total = 0;
    					while($row=mysqli_fetch_array($quer)){
                           ...
                           $income =  $total; 
    						?>
                                <h3>Year2 SCHOOL FEE Payment History Total Income: #<?php echo $income;?></h3>
                            </div>
       ...
       <div class="result">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
							 <form method="POST" action="receiptnd2.php" >
							     <td><input type="text" value="<?php echo $mat;?>" name='id'></td>
...
$(document).ready(function(){
    $('#category').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backened2.php", {term: inputVal}).done(function(data){
