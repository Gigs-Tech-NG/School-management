...
<body> 
 ...
 <?php
  ...
  if($norow >=1) {
   ...
   $query=mysqli_query($connection,"INSERT INTO COURSESREG (discipline,fullname,matricno,session,faculty,dept,level,semester,course,examscore,cascore,regdate) 
