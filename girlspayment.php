...
$(document).ready(function() {
   ...
   <!-- Header Menu Area End Here -->
    ...
    <?php  include"side_bars/buser_sidebar.php"; ?>
               ...
               <!-- Sidebar Area End Here -->            <div class="dashboard-content-one">
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Allocate Girls rooms to students</h3>
                            </div>
                        ...
                        $insert=mysqli_query($connection,"insert into room_booking(email,room,bunk,paid,remain,'gender') values('$name','$room','$bunk','$paid','$remain','female')");
                        if($bunk =="bunk1"){
                            $update= mysqli_query($connection,"update hostel2 set bunk1='chosen' where id='$room'");
                        }elseif($bunk =="bunk2"){
                            $update= mysqli_query($connection,"update hostel2 set bunk2='chosen' where id='$room'");
                        }elseif($bunk =="bunk3"){
                            $update= mysqli_query($connection,"update hostel2 set bunk3='chosen' where id='$room'");
                        }elseif($bunk =="bunk4"){
                            $update= mysqli_query($connection,"update hostel2 set bunk4='chosen, where id='$room'");
                        }else{
                            echo "not updated";
                        }
                       if(!$insert){
...
// Compose a simple HTML email message
   ...
   $message .= '</body></html>';
    ...
    <option>select room*</option>
        <?php $query_room = mysqli_query($connection,"SELECT *  FROM hostel2 WHERE bunk1='bunk1' OR bunk2='bunk2' OR bunk3='bunk3' OR bunk4='bunk4'") or die("Query failed: ".mysqli_error());
