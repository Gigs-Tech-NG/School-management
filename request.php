...
<head>
    ...
    <title>Request For Hostel</title>
            ...
            <div class="login-box">
                ...
                <form action="" method="POST"class="login-form">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Secret Pin" name="email" class="form-control" required=""/>
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        <div class="form-check">
                            ...
                            <h2 style="color:red;">Pin will be sent to student registered email within 24 hours </h2>
                        </div>
