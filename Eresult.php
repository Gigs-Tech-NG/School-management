...
<head>
        ...
        <?php require("includes/constants.php");require("includes/functions.php");?>
 ...
 <li>Dashboard</li>
        ...
        $pin=mysqli_real_escape_string($connection,$_POST['pin']);
               ...
               <h4 style="color:red"><?php echo validate(); ?></h4>
                        ...
                        <form class="new-added-form" method="post"   enctype="multipart/form-data" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="check" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Check</button>
