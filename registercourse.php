...
<head>
 ...
 <li>Dashboard</li>
               ...
               <h4 style="color:red">VIEW REGISTERED COURSES</h4>
       ...
       <option value="">Select dept first </option>
                    ...
                    <option value="">Select level first </option>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">View COURSE(S)</button>
                                     <div class="help-block with-errors"></div>
