        ...
        <ul class="nav nav-sidebar-menu sidebar-toggle-view">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>VIEW REGISTERED COURSE(S)</h3>
                    <ul>
                         <li>
...
?>
                                        ...
                                        <tr>
                                         ...
                                         <?php $finalsum =$row['creditunit'];
                                              ...
                                              <td>  <a href="removecourse.php?courseRegId=<?php echo $row['CRId']?>" target="_blank" onclick="return confirm('Are you sure you want to remove this course?')">
                            <button  class="btn btn-danger" role="button"><i class="fa fa-remove "></i> REMOVE</button> </a>    </td>  
                                        </tr>
