...
<head>
   ...
   $facultyi=htmlspecialchars($_POST['add']);
  $facultyid= strtoupper($facultyi);
   $sel_dept=mysqli_query($connection,"SELECT * FROM faculties WHERE name='$facultyid'");
   $norow=mysqli_num_rows($sel_dept);
   if($norow >=1) {
     $failure = "Department ALREADY EXIST";
   } 
   else{
   $query=mysqli_query($connection,"INSERT INTO faculties(name) VALUES('$facultyid')");
   if($query) {
     $success = "Department added successfully";
   } else{
      $failure =  "Department insertion failed"; 
                        ...
                        <form method="post" action="">
                             ...
                             <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="DEPARTMENTS"  name="add" class="form-control" style = "text-transform:uppercase" required>
                                </div>
