            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Year4 <?php echo $faculty ;?> STUDENTS (<?php
    ...
    echo date('Y',time());?> )Session</li>
                ...
                <div class="card height-auto">
                    <div class="card-body">
    					...
    					include('config.php');
    					$lvl=400;
    					$quer=mysqli_query($connection,"SELECT fee_four FROM application WHERE level='$lvl'");
                        $total = 0;
    					while($row=mysqli_fetch_array($quer)){
                           ...
                           $income =  $total; 
    						?>
                                <h3>Year4 SCHOOL FEE Payment History Total Income: #<?php echo $income;?></h3>
                            </div>
...
?></p>
                            <table class="table data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
						 <form method="POST" action="receipthnd2.php" >
						     <td><input type="text" value="<?php echo $id1;?>" name='id'></td>
                                     <td><input type="text" name="studentname" value="<?php echo $fullname;?>" required></td>
                                        ...
                                        <td><input type="text"  value="#<?php echo $balance;?>" disabled=""></td>
                                            <div class="dropdown">
...
$(document).ready(function(){
    $('#category').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backened4.php", {term: inputVal}).done(function(data){
