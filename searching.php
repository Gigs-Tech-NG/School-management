  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     ...
     {
      html += '<tr>';
       html += '<td>'+data[count].appId+'</td>';
      html += '<td>'+data[count].surname+'</td>';
      html += '<td>'+data[count].gender+'</td>';
      html += '<td>'+data[count].acceptancefee+'</td>';
      html += '<td>'+data[count].admissionstatus+'</td>';
      html += '<td>'+data[count].phone+'</td>';
      html += '<td>'+data[count].email+'</td>';
      html += '<td>'+data[count].processedate+'</td></tr>';
     }
    }
    else
    {
