    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <!-- Sidebar Area End Here -->
            <div class="dashboard-content-one">
               ...
               <h4 style="color:red">Remove PROGRAMME</h4>
...
<form action="removedelectprogram.php" method="post" class="regform" role="form" >
 ...
 ?>
                    ...
                    <div class="help-block with-errors"></div>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Remove PROGRAMME(S)</button>
                                     <div class="help-block with-errors"></div>
