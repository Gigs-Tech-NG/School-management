...
<html lang="zxx">
 ...
 <li>Dashboard</li>
                        ...
                        <form class="new-added-form">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" disabled="" value="<?php echo $fullname;?>" name="first_name" class="form-control">
                                </div>
                                 <div class="col-lg-3 form-group" style="width:50%">
                                     <label>Gender *</label>
                                 ...
                                 <div class="col-lg-3 form-group" style="width:50%">
                                    ...
                                    <input type="text" placeholder="dd/mm/yyyy" disabled="" name="dbirth"  value="<?php echo $bdirth;?>" class="form-control air-datepicker" data-position="bottom right">
                               ...
                               <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="tel" placeholder="" disabled="" value="<?php echo $phone;?>" class="form-control">
                                </div>
                                  <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Contact Address *</label>
                                   <textarea class="textarea form-control" disabled="" name="message" id="form-message" cols="10" rows="4"><?php echo $address;?></textarea>
                                </div>
                                 <div class="col-lg-3 form-group" style="width:50%">
                                    <label>State *</label>
                                    <select class="select2" name = "state"  disabled="" id="state">
                                 ...
                                 <div class="col-lg-3 form-group" style="width:50%">
                                    <label>L.G.A *</label>
                                    <select class="select2" name="lga" disabled="" id="lga">
                                ...
                                <div class="col-lg-3 form-group" style="width:50%">
                                    <label>Matric No *</label>
                                     <input type="text" placeholder="" value="<?php echo $matricNo;?>"  disabled=" " class="form-control">
                                    </div>
                                 <div class="col-lg-3 form-group" style="width:50%">
                                    ...
                                    <select class="select2" disabled="">
                                        <option value=""><?php echo $marital ;?></option>
        ...
        <div class="item-title" style="width: 100%;border: 2px solid #c4e3f3; border-radius: 10px; background: #c4e3f3; border: none;">
             <h3 style=" margin-left:7%; text-transform: uppercase; color: red;">Academic Information</h3>
                            </div>
                           <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" 
                                data-toggle="dropdown" aria-expanded="false">...</a>
                        ...
                        <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder=""  value="<?php echo $faculty;?>" disabled="" class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Programme *</label>
                                    <input type="text" placeholder=""  value="<?php echo $department;?>" disabled="" class="form-control">
                                </div>
                                
                                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Level *</label>
                                    <input type="text" placeholder="" value="<?php echo $level;?>" disabled="" class="form-control">
                                </div>
